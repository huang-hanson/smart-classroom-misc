...
public class ColumnController extends BaseController {
    ...
    public WebResult<?> page(
        ...
        for (ColumnDTO columnDTO : columnDTOPagerResponse.getData()) {
            ...
            if (readerDTO != null) {
                subscriptionDTO = subscriptionReadFacade.queryByColumnAndReaderId(new ReaderColumnQueryRequest(
                        readerDTO.getId(),
                        columnDTO.getId()
                ));
            }
        ...
        PagerResponse<RichColumnDTO> richColumnDTOPagerResponse = new PagerResponse<>(
        ...
        return success(richColumnDTOPagerResponse);
    }
