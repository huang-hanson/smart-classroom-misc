...
public class GlobalExceptionConfiguration {
    ...
    public WebResult<?> handleBindException(HttpServletRequest req, BindException exception) {
        ...
        for (ObjectError objectError : errorList) {
            ...
            if (objectError instanceof FieldError) {
                ...
                if (fieldError.getRejectedValue() == null || Objects.equals(fieldError.getRejectedValue(), "")) {
                    ...
                    message.append(StringUtil.format("{}:{}:{};", fieldError.getField(), objectError.getDefaultMessage(), StringUtil.digest(StringUtil.format("{}", fieldError.getRejectedValue()), 10, 6), objectError.getDefaultMessage()));
                }
            } else {
        ...
        WebResult<Object> webResult = new WebResult<>(ResultCode.PARAMS_ERROR, message.toString());
